...
class COCODataset(BaseDataset):
    ...
    def _load_coco_keypoint_annotation_kernel(self, index):
        ...
        for obj in objs:
            ...
            joints_3d_visible = np.zeros((self.num_joints, 3), dtype=np.float)
    ...
    def image_path_from_index(self, index):
        ...
        image_path = os.path.join(
            self.root, 'images', prefix, file_name)
    ...
    def _do_python_keypoint_eval(self, res_file):
        ...
        coco_eval.summarize()
        stats_names = ['ap', 'ap_50', 'ap_75', 'ap_m', 'ap_l',
                       'ar', 'ar_50', 'ar_75', 'ar_m', 'ar_l']

        return zip(stats_names, coco_eval.stats)
